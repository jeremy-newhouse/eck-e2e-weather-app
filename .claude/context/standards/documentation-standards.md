...
This directory contains documentation standards: rules and templates for creating and maintaining documentation. These are the "rules for the rules" that ensure consistency across all standards in this repository.

## Standards in This Section

### [business-requirements-standard.md](./business-requirements-standard.md)
Standard for creating Business Requirements Documents (BRDs):
- When to create a BRD vs skip to specifications
- BRD tiers (Full, Standard, Lightweight)
- Required sections and format
- Workflow: BRD → PRD → Architecture → Specifications → Implementation → QA
- Traceability from business requirements to product requirements

### [product-requirements-standard.md](./product-requirements-standard.md)
Standard for creating Product Requirements Documents (PRDs):
- When to create a PRD vs skip to specifications
- PRD tiers (Full, Standard, Lightweight)
- Required sections (personas, user stories, features)
- Workflow position between BRD and Specifications
- Traceability from product features to specifications

### [documentation-standard.md](./documentation-standard.md)
The primary standard for creating documentation:
- Document structure templates
- Naming conventions (kebab-case)
- Content guidelines and writing style
- **Diagrams and Visual Documentation** - Mermaid (inline) and Draw.io (standalone) standards
- Version control and metadata requirements
- Quality checklists

### [architecture-definition.md](./architecture-definition.md)
Standard for creating project-specific architecture documentation:
- Architecture repository structure
- Templates for system documentation
- Integration with main standards

### [specification-standard.md](./specification-standard.md)
Standard for writing feature specifications:
- Specification tiers (Full, Standard, Light)
- Required sections and format
- User stories and acceptance criteria
- Templates reference
- Traceability to business requirements (BRD)

### [discovery-standard.md](./discovery-standard.md)
Standard for the Discovery phase:
- Stakeholder interview methodology
- Problem validation process
- When to conduct Discovery vs skip to BRD/PRD
- Discovery deliverables and document format

### [agentic-coding-standard.md](./agentic-coding-standard.md)
Standard for AI agents when generating or modifying code:
- Source-of-truth hierarchy
- Protected paths and security constraints
- Quality gates and verification discipline
- Commit and PR formatting requirements

### [document-template.md](./document-template.md)
Template for creating new documentation:
- Standard document structure
- Metadata fields (version, status, date)
...
1. Read `documentation-standard.md` first
2. Use kebab-case for file/directory names
3. Include version, date, and status metadata
...
|------|--------|-------------|
| Inline | Mermaid | Simple diagrams, version-controlled text |
| Standalone | Draw.io | Complex architecture, network topology |

See `documentation-standard.md#diagrams-and-visual-documentation` for full guide.

## Related Categories

- [Templates](../templates/README.md) - Code and documentation templates
...
git init
# Follow new-project-setup.md Phase 2

# Create backend repository
mkdir {project-name}-backend && cd {project-name}-backend
git init
# Follow new-project-setup.md Phase 3
```
...
|-------|-------|-------------|
| Phase 1 (MVP) | BR-001, BR-002 | Q1 2025 |
| Phase 2 | BR-003, BR-004 | Q2 2025 |
```
...
| **Recommendation** | Next phase recommendation (BRD, PRD, or Spec) |
...
- [ ] Next phase recommendation made (BRD, PRD, or Specification)
...
This template provides the standard structure for creating new documentation files in this repository. Copy this template when creating new standards, guides, or reference documents.

---

## Template

Copy the content below when creating a new document:
...
[Optional: Summary table or bullet points for quick lookup]
...
```language
// Annotated bad example with explanation of why it's wrong
```
...
- **Active**: Current, approved standard
...
### Purpose
- Single paragraph
- Answer: "Why does this document exist?"
- Be specific about the problem being solved

### Scope
- Clarify boundaries
- List what IS covered
- List what is NOT covered (and where to find it)

### Main Content
- Use logical groupings
- Progressive disclosure (simple → complex)
- Include code examples for technical content
- Use tables for comparisons or quick lookups

### Best Practices
- Always include Do/Don't sections for standards
...
1. Numbers for ordered/sequential steps
```

### Links
```markdown
[Link text](./relative-path.md)           # Same directory
[Link text](../category/file.md)          # Parent directory
[Link text](./category/subcategory/file.md) # Child directory
```
...
- Match the document's main topic
- Examples:
  - `server-actions.md` (not `ServerActions.md`)
  - `naming-conventions.md` (not `naming.md`)
  - `tech-stack.md` (not `technology-stack-overview.md`)

---

## Checklist for New Documents

Before finalizing a new document:

- [ ] Metadata complete (version, date, status)
- [ ] Purpose clearly stated
- [ ] Scope defined
- [ ] Code examples tested/verified
- [ ] Good/bad examples included (for standards)
- [ ] Related standards linked
- [ ] Added to category README.md
...
- [Documentation Standard](./documentation-standard.md) - Comprehensive documentation guidelines
- [Architecture Definition](./architecture-definition.md) - Architecture repository structure
- [Specification Standard](./specification-standard.md) - Feature specification templates
...
|-------|----------|--------|--------------|
| Phase 1 (MVP) | FEAT-001, FEAT-002 | {Date} | None |
| Phase 2 | FEAT-003, FEAT-004 | {Date} | Phase 1 |
| Phase 3 | FEAT-005 | {Date} | Phase 2 |
